    ...
    var WordCloud = function WordCloud(elements, options) {
        ...
        switch (settings.color) {
            ...
            case 'custom':
                ...
                getTextColor = function getPredefinedColor() {

                    var generatedColor = Math.floor(Math.random() * settings.wordsColors.length);

                    generatedColor = settings.wordsColors[generatedColor];
