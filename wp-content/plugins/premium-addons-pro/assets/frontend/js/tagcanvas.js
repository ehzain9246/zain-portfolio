...
(function ($) {
    ...
    function FindTextBoundingBox(s, f, ht) {
        ...
        c.fillStyle = '#000';
        c.fillRect(0, 0, w, h);
        TextSet(c, ht + 'px ' + f, '#fff', s, 0, 0, 0, 0, [], 'centre', 'normal')
    ...
    Tproto.Measure = function (c, t) {
        ...
        if (t.txtOpt) {
            ...
            f = this.textWeight + ' ' + th + 'px ' + this.textFont;
    ...
    function TagCanvas(cid, lctr, opt) {
        ...
        this.textWeight = this.textWeight;
        this.textHeight *= 1;
    ...
    TCproto.CreateTag = function (e) {
        ...
        if (ts || i) {
            t = new Tag(this, txt, e, p, 2, this.textHeight + 2,
                ...
                boc, this.bgOutlineThickness, font, this.padding, ts && ts.original, this.textWeight);
            if (i) {
                t.SetImage(i);
                AddImage(i, im[0], im[1], t, this);
            } else {
