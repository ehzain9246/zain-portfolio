...
class Premium_Unfold extends Widget_Base {
	...
	protected function render_unfold_button() {
        ...
        $aria_label = $settings['premium_unfold_button_fold_text'];

		?>
		<a class="premium-button <?php echo esc_attr( $button_size ); ?>" href="javascript:;" aria-label="<?php echo esc_attr( $aria_label ); ?>">
